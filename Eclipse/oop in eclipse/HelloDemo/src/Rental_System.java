...
class CarRentalSystem {
    ...
    public void returnCar(Car car) {
        ...
        for (Rental rental : rentals) {
            if (rental.getCar().getCarId().equals(car.getCarId())) { // Compare by ID, not object reference
        ...
        if (rentalToRemove != null) {
            ...
            System.out.println("Car was not rented or rental record missing.");
        }
    }
...
public class Rental_System {
    public static void main(String[] args) {
        ...
        // Adding cars with different rental prices per day
